...
public class Payment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setForeground(new java.awt.Color(0, 118, 211));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            ResultSet rs1=st.executeQuery("select * from member inner join payment where payment.month='"+month+"' and payment.id='"+id+"' and member.id='"+id+"'");
            while(rs1.next())
            {
